...
export const ListMyVpnKeysResponseItem = zod.object({
  ...
  "xrayCleanupPendingAt": zod.coerce.date().nullish(),
...
export const ListAdminUsersResponseItem = zod.object({
  ...
  "inviteLinkCode": zod.string().nullish(),
  "inviteLinkNote": zod.string().nullish(),
  "referredUserCount": zod.number(),
  "role": zod.enum(['user', 'admin']),
  "createdAt": zod.coerce.date(),
  ...
  "activeSubscriptionEndsAt": zod.coerce.date().nullish(),
