 ...
 */
export const changeMyEmail = async (changeEmailInput: ChangeEmailInput, options?: RequestInit): Promise<Me> => {

  return customFetch<Me>(getChangeMyEmailUrl(),
  {
    ...options,
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getChangeMyEmailMutationOptions = <TError = ErrorType<ErrorEnvelope>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof changeMyEmail>>, TError,{data: BodyType<ChangeEmailInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof changeMyEmail>>, TError,{data: BodyType<ChangeEmailInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof changeMyEmail>>, {data: BodyType<ChangeEmailInput>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type ChangeMyEmailMutationResult = NonNullable<Awaited<ReturnType<typeof changeMyEmail>>>
    export type ChangeMyEmailMutationBody = BodyType<ChangeEmailInput>
    export type ChangeMyEmailMutationError = ErrorType<ErrorEnvelope>

    /**
 * @summary Change the current user's login email (requires current password)
 */
export const useChangeMyEmail = <TError = ErrorType<ErrorEnvelope>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof changeMyEmail>>, TError,{data: BodyType<ChangeEmailInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
 ...
 */
export const changeMyPassword = async (changePasswordInput: ChangePasswordInput, options?: RequestInit): Promise<ChangePasswordResult> => {

  return customFetch<ChangePasswordResult>(getChangeMyPasswordUrl(),
  {
    ...options,
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getUpdatePaymentScreenshotUrl = (paymentId: number,) => {




  return `/api/payments/${paymentId}/screenshot`
}
...
export const updatePaymentScreenshot = async (paymentId: number,
    paymentScreenshotUpdate: PaymentScreenshotUpdate, options?: RequestInit): Promise<Payment> => {

  return customFetch<Payment>(getUpdatePaymentScreenshotUrl(paymentId),
  {
    ...options,
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(paymentScreenshotUpdate)
  }
);}
...
export const getUpdatePaymentScreenshotMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updatePaymentScreenshot>>, TError,{paymentId: number;data: BodyType<PaymentScreenshotUpdate>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updatePaymentScreenshot>>, TError,{paymentId: number;data: BodyType<PaymentScreenshotUpdate>}, TContext> => {

const mutationKey = ['updatePaymentScreenshot'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updatePaymentScreenshot>>, {paymentId: number;data: BodyType<PaymentScreenshotUpdate>}> = (props) => {
          const {paymentId,data} = props ?? {};

          return  updatePaymentScreenshot(paymentId,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdatePaymentScreenshotMutationResult = NonNullable<Awaited<ReturnType<typeof updatePaymentScreenshot>>>
    export type UpdatePaymentScreenshotMutationBody = BodyType<PaymentScreenshotUpdate>
    export type UpdatePaymentScreenshotMutationError = ErrorType<unknown>

    /**
 * @summary Attach a payment confirmation screenshot to a pending payment
 */
export const useUpdatePaymentScreenshot = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updatePaymentScreenshot>>, TError,{paymentId: number;data: BodyType<PaymentScreenshotUpdate>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof updatePaymentScreenshot>>,
        TError,
        {paymentId: number;data: BodyType<PaymentScreenshotUpdate>},
        TContext
      > => {
...
export const getDeleteVpnNodeMutationOptions = <TError = ErrorType<DeleteVpnNode409>,
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeleteVpnNodeMutationError = ErrorType<DeleteVpnNode409>

    /**
 * @summary Delete a VPN node and migrate its active keys to other nodes
 */
export const useDeleteVpnNode = <TError = ErrorType<DeleteVpnNode409>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteVpnNode>>, TError,{nodeId: number}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
...
export const getGetAdminInviteLinkUsersQueryKey = (linkId: number,) => {
    return [
    `/api/admin/invite-links/${linkId}/users`
    ] as const;
    }
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetAdminInviteLinkUsersQueryKey(linkId);
   ...
   return  { queryKey, queryFn, enabled: linkId !== null && linkId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getAdminInviteLinkUsers>>, TError, TData> & { queryKey: QueryKey }
}
...
export function useGetAdminInviteLinkUsers<TData = Awaited<ReturnType<typeof getAdminInviteLinkUsers>>, TError = ErrorType<unknown>>(
 linkId: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getAdminInviteLinkUsers>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
...
export const adminSetUserBalance = async (userId: number,
    adminSetUserBalanceRequest: AdminSetUserBalanceRequest, options?: RequestInit): Promise<AdminUser> => {
  ...
  return customFetch<AdminUser>(getAdminSetUserBalanceUrl(userId),
  {
    ...
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(adminSetUserBalanceRequest)
  }
);}
...
export const getAdminSetUserBalanceMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof adminSetUserBalance>>, TError,{userId: number;data: BodyType<AdminSetUserBalanceRequest>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof adminSetUserBalance>>, TError,{userId: number;data: BodyType<AdminSetUserBalanceRequest>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof adminSetUserBalance>>, {userId: number;data: BodyType<AdminSetUserBalanceRequest>}> = (props) => {
          const {userId,data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type AdminSetUserBalanceMutationBody = BodyType<AdminSetUserBalanceRequest>
...
export const useAdminSetUserBalance = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof adminSetUserBalance>>, TError,{userId: number;data: BodyType<AdminSetUserBalanceRequest>}, TContext>, request?: SecondParameter<typeof customFetch>}
        ...
        TError,
        {userId: number;data: BodyType<AdminSetUserBalanceRequest>},
        TContext
      > => {
...
export const adminSetUserPassword = async (userId: number,
    adminSetUserPasswordRequest: AdminSetUserPasswordRequest, options?: RequestInit): Promise<void> => {
  ...
  return customFetch<void>(getAdminSetUserPasswordUrl(userId),
  {
    ...
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(adminSetUserPasswordRequest)
  }
);}
...
export const getAdminSetUserPasswordMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof adminSetUserPassword>>, TError,{userId: number;data: BodyType<AdminSetUserPasswordRequest>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof adminSetUserPassword>>, TError,{userId: number;data: BodyType<AdminSetUserPasswordRequest>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof adminSetUserPassword>>, {userId: number;data: BodyType<AdminSetUserPasswordRequest>}> = (props) => {
          const {userId,data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type AdminSetUserPasswordMutationBody = BodyType<AdminSetUserPasswordRequest>
...
export const useAdminSetUserPassword = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof adminSetUserPassword>>, TError,{userId: number;data: BodyType<AdminSetUserPasswordRequest>}, TContext>, request?: SecondParameter<typeof customFetch>}
        ...
        TError,
        {userId: number;data: BodyType<AdminSetUserPasswordRequest>},
        TContext
      > => {
 ...
 */
export const sendAdminBroadcast = async (adminBroadcastInput: AdminBroadcastInput, options?: RequestInit): Promise<SendAdminBroadcastResult> => {

  return customFetch<SendAdminBroadcastResult>(getSendAdminBroadcastUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(adminBroadcastInput)
  }
);}
...
export const getSendAdminBroadcastMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof sendAdminBroadcast>>, TError,{data: BodyType<AdminBroadcastInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof sendAdminBroadcast>>, TError,{data: BodyType<AdminBroadcastInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof sendAdminBroadcast>>, {data: BodyType<AdminBroadcastInput>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type SendAdminBroadcastMutationBody = BodyType<AdminBroadcastInput>
    export type SendAdminBroadcastMutationError = ErrorType<void>

    /**
 * @summary Send a broadcast notification to a set of users
 */
export const useSendAdminBroadcast = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof sendAdminBroadcast>>, TError,{data: BodyType<AdminBroadcastInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
...
export const getListAdminBroadcastsUrl = (params?: ListAdminBroadcastsParams,) => {
  const normalizedParams = new URLSearchParams();
 ...
 */
export const listAdminBroadcasts = async (params?: ListAdminBroadcastsParams, options?: RequestInit): Promise<AdminBroadcastListResponse> => {

  return customFetch<AdminBroadcastListResponse>(getListAdminBroadcastsUrl(params),
  {
    ...options,
    method: 'GET'
...
export const getListAdminBroadcastsQueryKey = (params?: ListAdminBroadcastsParams,) => {
    return [
...
export const getListAdminBroadcastsQueryOptions = <TData = Awaited<ReturnType<typeof listAdminBroadcasts>>, TError = ErrorType<unknown>>(params?: ListAdminBroadcastsParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listAdminBroadcasts>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getListAdminBroadcastsQueryKey(params);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof listAdminBroadcasts>>> = ({ signal }) => listAdminBroadcasts(params, { signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listAdminBroadcasts>>, TError, TData> & { queryKey: QueryKey }
}

export type ListAdminBroadcastsQueryResult = NonNullable<Awaited<ReturnType<typeof listAdminBroadcasts>>>
export type ListAdminBroadcastsQueryError = ErrorType<unknown>
...
export function useListAdminBroadcasts<TData = Awaited<ReturnType<typeof listAdminBroadcasts>>, TError = ErrorType<unknown>>(
 params?: ListAdminBroadcastsParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listAdminBroadcasts>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
...
export const getGetAdminTrafficPollingHealthUrl = () => {
  ...
  return `/api/admin/health/traffic-polling`
}

/**
 * @summary Get traffic polling health status (last success time + consecutive failure count)
 */
export const getAdminTrafficPollingHealth = async ( options?: RequestInit): Promise<TrafficPollingHealth> => {

  return customFetch<TrafficPollingHealth>(getGetAdminTrafficPollingHealthUrl(),
  {
    ...options,
    method: 'GET'
...
export const getGetAdminTrafficPollingHealthQueryKey = () => {
    return [
    `/api/admin/health/traffic-polling`
    ] as const;
    }


export const getGetAdminTrafficPollingHealthQueryOptions = <TData = Awaited<ReturnType<typeof getAdminTrafficPollingHealth>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getAdminTrafficPollingHealth>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetAdminTrafficPollingHealthQueryKey();



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getAdminTrafficPollingHealth>>> = ({ signal }) => getAdminTrafficPollingHealth({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getAdminTrafficPollingHealth>>, TError, TData> & { queryKey: QueryKey }
}

export type GetAdminTrafficPollingHealthQueryResult = NonNullable<Awaited<ReturnType<typeof getAdminTrafficPollingHealth>>>
export type GetAdminTrafficPollingHealthQueryError = ErrorType<unknown>
...
export function useGetAdminTrafficPollingHealth<TData = Awaited<ReturnType<typeof getAdminTrafficPollingHealth>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getAdminTrafficPollingHealth>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetAdminTrafficPollingHealthQueryOptions(options)
 ...
 */
export const getAdminAuditLog = async (params?: GetAdminAuditLogParams, options?: RequestInit): Promise<AdminAuditLogListResponse | string> => {

  return customFetch<AdminAuditLogListResponse | string>(getGetAdminAuditLogUrl(params),
  {
    ...options,
    method: 'GET'
...
export const getGetAdminAuditLogQueryOptions = <TData = Awaited<ReturnType<typeof getAdminAuditLog>>, TError = ErrorType<unknown>>(params?: GetAdminAuditLogParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getAdminAuditLog>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
