          ...
          <div className="flex flex-col md:flex-row gap-10 items-start">
            ...
            <div className="flex-1 space-y-5">
              ...
              <h2 className="text-3xl md:text-4xl font-black tracking-tight leading-tight">
                ...
                <span className="text-orange-400">получайте бонусы</span>
              </h2>
              {referralCommission > 0 ? (
                <p className="text-gray-400 text-sm leading-relaxed">
                  Каждый действующий пользователь получает{" "}
                  <span className="text-orange-400 font-bold">{referralCommission}%</span>{" "}
                  от подтверждённых оплат подписок своих рефералов на внутренний баланс. Пополнения кошелька
                  не учитываются. Баланс автоматически идёт в счёт подписки — никакого вывода не нужно.
                </p>
              ) : (
                <p className="text-gray-400 text-sm leading-relaxed">
                  Каждый действующий пользователь получает процент от подтверждённых оплат подписок своих
                  рефералов на внутренний баланс. Пополнения кошелька не учитываются. Баланс автоматически
                  идёт в счёт подписки — никакого вывода не нужно.
                </p>
              )}
              <p className="text-gray-300 text-sm font-medium">
                {referralCommission > 0
                  ? "В прогресс попадают только рефералы с подтверждённой оплатой подписки; сумма начисления зависит от размера оплаты."
                  : "Приглашайте друзей и получайте комиссию с их подтверждённых оплат подписки."}
              </p>
              <Link
                href="/sign-in"
            ...
            <div className="flex-shrink-0 w-full md:w-64 space-y-4">
              {[
                ...
                },
                {
                  ...
                  desc: "Как только подтверждена его оплата подписки — комиссия поступает на ваш баланс",
                },
                {
                  n: "03",
