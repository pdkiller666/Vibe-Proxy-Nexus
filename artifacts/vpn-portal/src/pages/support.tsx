...
const FAQ = [
  {
    ...
    a: "Установите приложение Happ (iOS/Android) или v2rayNG (Android). В разделе «Подключение» скопируйте ссылку или отсканируйте QR-код — приложение добавит VPN автоматически.",
  },
  {
  ...
  },
  {
    ...
    a: "В разделе «Подключение» откройте блок «Мои устройства» и нажмите «Добавить ещё устройство». Количество устройств зависит от тарифа. Если места закончились — его можно докупить там же.",
  },
  {
  ...
  },
  {
    ...
    a: "Подписка продлевается автоматически только при включённой настройке автопродления и достаточном балансе. Если автопродление выключено или баланс заканчивается, перейдите в «Тарифы и оплату» и выберите нужное действие.",
  },
  {
    q: "Безопасно ли использовать VPNexus?",
    a: "Да. Мы не храним логи трафика. Каждый пользователь получает уникальный ключ. Фирменная технология маскировки VPNexus шифрует соединение и маскирует его под обычный HTTPS.",
  },
];
