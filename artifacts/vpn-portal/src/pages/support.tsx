...
const FAQ = [
  ...
  },
  {
    ...
    a: "В разделе «Ключи VPN» нажмите «Добавить устройство». Количество устройств зависит от тарифа. Если слоты закончились — можно докупить доп. устройство в разделе «Тарифы».",
  },
  {
